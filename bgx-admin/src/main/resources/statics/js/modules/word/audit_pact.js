    ...
    layer.prompt({
        ...
        yes: function (index, layero) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: baseURL + "word/" + controllerUrl + "/updateByPactStatus",
 ...
 * 全部审核通过
 */
function updateByPactStatusSuccess() {
    layer.prompt({
            title: '一键审核通过',
            btn: ['通过', '取消'],
            formType: 2,
 ...
 * 全部审核不通过
 */
function updateByPactStatusFailure() {
    layer.prompt({
            title: '一键审核不通过',
            btn: ['不通过', '取消'],
            formType: 2,
 ...
 * 初始化
 */
function updateByPactStatusDefault() {
    $.ajax({url: baseURL + "word/" + controllerUrl + "/updateByPactStatusDefault", async: false});
    vm.reload();
};