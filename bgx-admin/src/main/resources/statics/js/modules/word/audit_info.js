    ...
    layer.prompt({
        ...
        yes: function (index, layero) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: baseURL + "word/" + controllerUrl + "/updateByInfoStatus",
 ...
 * 全部审核通过
 */
function updateByInfoStatusSuccess() {
    layer.prompt({
            title: '一键审核通过',
            btn: ['通过', '取消'],
            formType: 2,
 ...
 * 全部审核不通过
 */
function updateByInfoStatusFailure() {
    layer.prompt({
            title: '一键审核不通过',
            btn: ['不通过', '取消'],
            formType: 2,
 ...
 * 初始化
 */
function updateByInfoStatusDefault() {
    $.ajax({url: baseURL + "word/" + controllerUrl + "/updateByInfoStatusDefault", async: false});
    vm.reload();
};